...
// ANSWER: No, it's already constant and the most basic it can be
...
// ANSWER: NO matter what youre gonna have to run through a for loop
...
// ANSWER: Yes, they're pushing the same string and gonna run thorugh the same amount of times 
...
// ANSWER: Each function uses the same string, different methods but they also use higher order array methods
